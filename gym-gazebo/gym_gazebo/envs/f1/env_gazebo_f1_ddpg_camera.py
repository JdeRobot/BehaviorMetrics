...
class GazeboF1CameraEnvDDPG(gazebo_env.GazeboEnv):
    """
    Description:
    ...
    Observation: 
        ...
        4   Error 3                  -250   250
    Actions:
        Continuous with Max and Min Linear velocity of 12 and 2 m/s respectively, and, Max Absolute Angular Velocity
        of 1.5 rad/s
    Reward:
    ...
    def __init__(self):
        ...
        self.action_space = self._generate_continuous_action_space()
