...
class StatsWindow(QMainWindow):
    def __init__(self, parent=None, controller=None):
        ...
        self.completed_distance_label = QLabel("Completed distance -> " + str(self.controller.statistics['completed_distance']) + "m")
        ...
        if 'lap_seconds' in self.controller.statistics:
            self.lap_seconds_label = QLabel("Lap seconds -> " + str(self.controller.statistics['lap_seconds']) + "s")
            self.layout.addWidget(self.lap_seconds_label)
            self.average_speed_label = QLabel("Average speed -> " + str(self.controller.statistics['average_speed']) + "m/s")
            self.layout.addWidget(self.average_speed_label)
            self.circuit_diameter_label = QLabel("Circuit diameter -> " + str(self.controller.statistics['circuit_diameter']) + "m")
