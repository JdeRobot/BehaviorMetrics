...
class Controller:
    ...
    def save_time_stats(self, mean_iteration_time, mean_inference_time, frame_rate):
        time_stats = {'mean_iteration_time': mean_iteration_time, 'mean_inference_time': mean_inference_time, 'frame_rate': frame_rate}
