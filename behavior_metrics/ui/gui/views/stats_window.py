...
class CARLAStatsWindow(QMainWindow):
    def __init__(self, parent=None, controller=None):
        ...
        self.gpu_inference_label = QLabel("GPU inference -> " + str(self.controller.experiment_metrics['gpu_inference']))
        self.layout.addWidget(self.gpu_inference_label)
        self.suddenness_distance_label = QLabel("Suddenness distance -> " + str(self.controller.experiment_metrics['suddenness_distance']))
        self.layout.addWidget(self.suddenness_distance_label)
        ...
        self.suddenness_distance_break_command_label = QLabel("Suddenness distance break command -> " + str(self.controller.experiment_metrics['suddenness_distance_break_command']))
        self.layout.addWidget(self.suddenness_distance_break_command_label)
        self.suddenness_distance_per_km_label = QLabel("Suddenness distance per km -> " + str(self.controller.experiment_metrics['suddenness_distance_per_km']))
        self.layout.addWidget(self.suddenness_distance_per_km_label)
        ...
        self.suddenness_distance_break_command_per_km_label = QLabel("Suddenness distance break command per km -> " + str(self.controller.experiment_metrics['suddenness_distance_break_command_per_km']))
        self.layout.addWidget(self.suddenness_distance_break_command_per_km_label)
