...
class StatsWindow(QMainWindow):
    def __init__(self, parent=None, controller=None):
        ...
        self.mean_brain_iterations_real_time_label = QLabel("Mean brain iterationsreal time -> " + str(self.controller.experiment_metrics['mean_brain_iterations_real_time']) + 's')
        ...
        self.target_brain_iterations_real_time_label = QLabel("Target brain iterationsreal time -> " + str(self.controller.experiment_metrics['target_brain_iterations_real_time']) + 'it/s')
        ...
        self.target_brain_iterations_simulated_time_label = QLabel("Target brain iterationssimulated time -> " + str(self.controller.experiment_metrics['target_brain_iterations_simulated_time']) + 'it/s')
        ...
        self.mean_brain_iterations_simulated_time_label = QLabel("Mean brain iterationssimulated time -> " + str(self.controller.experiment_metrics['mean_brain_iterations_simulated_time']))
