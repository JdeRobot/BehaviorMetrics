...
class Brain:
    ...
    def __init__(self, sensors, actuators, model=None, handler=None):
        ...
        #model_v='20210609-083754_lstm_13_points_3_examples_5_sample_weight_300_epochs_new_normalized_v.h5'
        #model_w='20210609-083754_lstm_13_points_3_examples_1_sample_weight_300_epochs_new_normalized_w.h5'
        ...
        model = '20210611-143421_lstm_31_points_3_examples_300_epochs_new_normalized_sample_weight_2_5_5_10_all_sequences.h5'
        if model:
    ...
    def execute(self):
        ...
        try:
            ...
            img_points = [mask[0], mask[2], mask[4], mask[6], mask[8], mask[10], 
                      mask[12], mask[14], mask[16], mask[18], mask[20], 
                      mask[22], mask[24], mask[26], mask[28], mask[30], 
                      mask[32], mask[34], mask[36], mask[38], mask[40], 
                      mask[42], mask[44], mask[46], mask[48], mask[50],
                      mask[52], mask[54], mask[56], mask[58], mask[59]]
            ...
            prediction_v = prediction[0][0]*11
