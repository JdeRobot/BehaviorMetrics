...
class Brain:
    ...
    def imgProc(self, _img, init=False):
        ...
        image_mask = cv2.inRange(_img, lower_red, upper_red)
        histogram = np.sum(image_mask[self.rows[0]:self.rows[1], :], axis=0)
    ...
    def execute(self):
        try:
            ...
            if self.isReady is False:
                ...
                #print("Wheel// Errors: " + str(error) + ", KPW: " + str(KPW) + ", KIW: " + str(KIW) + ", KDW: " + str(
