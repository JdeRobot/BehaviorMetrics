...
def main():
    ...
    try:
        ...
        start_pose = carla.Transform(carla.Location(x=2.0, y=40, z=1.37), carla.Rotation(pitch=0, yaw=-90, roll=0))
        ...
        # clockwise
        #start_pose = carla.Transform(carla.Location(x=14.3, y=-237.3, z=1.37), carla.Rotation(pitch=0, yaw=10, roll=0))
        ...
        #model = "20221104-101558_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01_more_cp.h5"
        model = "20221104-112038_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01_extreme_cp.h5"
        model = "20221104-120121_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01_only_extreme_cp.h5"
        model = "20221104-120359_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01_only_clockwise_cp.h5"
        model = "20221104-121137_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01_only_clockwise_cp.h5"
        model = "20221104-124737_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01__cp_3.h5" # BEST!
        model = "20221104-124737_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01__cp.h5" # BEST!
        #model = "20221104-124737_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01__cp_2.h5"
        model = "20221104-124737_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01__cp.h5" # WORKS!!!
        ...
        #model = "20221104-151236_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_all_towns_vel_MAX_cp.h5"

        #model = "20221107-111832_pilotnet_CARLA_17_10_dataset_bird_eye_300_epochs_no_flip_3_output_velocity_town_01_extreme_vel_MAX_cp.h5" # Works for town01
        ...
        with CarlaSyncMode(world, camera_rgb, camera_semseg, fps=15) as sync_mode:
            while True:
                ...
                velocity_dim = np.full((150, 50), previous_speed/30)
                #print(velocity_dim)
                ...
                if vehicle_speed > 200:
                    ...
                    if vehicle_speed < 2: 
                        vehicle.apply_control(carla.VehicleControl(throttle=float(1.0), steer=0.0, brake=float(0.0)))
                    elif vehicle_speed > 5 and break_command > float(0.001):
                        print('1')
