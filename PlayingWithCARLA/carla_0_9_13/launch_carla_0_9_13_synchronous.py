    ...
    try:
        ...
        with CarlaSyncMode(world, camera_rgb, camera_semseg, fps=30) as sync_mode:
            while True:
                ...
                #vehicle.set_target_velocity(carla.Vector3D(10, 10, 10))
                #vehicle.set_autopilot(True)
                #vehicle.apply_control(carla.VehicleControl(throttle=1.0, steer=1.0, brake=float(0.0)))
                #vehicle.apply_control(carla.VehicleControl(0.75))
                clock.tick()
